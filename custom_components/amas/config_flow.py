...
# Set up host and Rest API key schema
...
async def validate_input(hass: HomeAssistant, data: dict[str, Any]) -> dict[str, Any]:
    ...
    hub = AMASHub(data["host"])

    if await hub.authenticate(data["api_key"]):
    ...
    return {"device_id": device_info['dev_id']}


class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for amastech."""
